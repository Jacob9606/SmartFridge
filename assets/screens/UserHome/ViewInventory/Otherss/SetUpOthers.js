...
const SetUpOthers = () => {
  ...
  const handleAddOthers = () => {
    // Logic to add Others with the specified critical status and quantity
    console.log(
      "Adding Others with quantity:",
      quantity,
      "Critical:",
      isCritical
    );
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.header}>Set Up Others</Text>
      ...
      <TouchableOpacity
        style={styles.addOthersButton}
        onPress={handleAddOthers}
      >
        <Text style={styles.addOthersButtonText}>Add Others</Text>
      </TouchableOpacity>
    </View>
  );
};
